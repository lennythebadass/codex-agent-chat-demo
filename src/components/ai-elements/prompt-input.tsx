...
export const PromptInputActionAddAttachments = ({
  ...
  const handleSelect: PromptInputActionAddAttachmentsProps["onSelect"] =
    useCallback(
      (event: PromptInputActionSelectEvent) => {
...
export const PromptInputActionAddScreenshot = ({
  ...
  const handleSelect: PromptInputActionAddScreenshotProps["onSelect"] =
    useCallback(async (event: PromptInputActionSelectEvent) => {
      onSelect?.(event);
